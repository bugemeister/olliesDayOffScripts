...
public class HealthManager : MonoBehaviour
{
    ...
    public void ResetHealth()
    {
        ...
        UIManager.instance.coinImage.enabled = true;
        UIManager.instance.coinText.enabled = true;
    }
    ...
    public void UpdateUI()
    {
        ...
        switch(currentHealth)
        {
            ...
            case 0:
                ...
                UIManager.instance.coinImage.enabled = false;
                UIManager.instance.coinText.enabled = false;
